...
-- JO_LIBS ONLY
-------------
--everything below registers once for the whole server, so it must not run in the resources
--loading the bridge: only jo_libs itself goes further
if jo.resourceName ~= "jo_libs" then return end
