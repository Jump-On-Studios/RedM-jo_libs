...
jo.i18n = {
  locale = GetConvar("jo_libs:i18n:locale", "en"),
  initialized = false,
  dict = {}
}
...
function jo.i18n.onLocaleChanged(callback)
  jo.hook.registerAction("jo_i18n_locale_changed", callback)
end
...
function jo.i18n.addEntries(entries)
  ...
  table.merge(jo.i18n.dict, strings)
end
...
function jo.i18n.__(key)
  ...
  return jo.i18n.dict[key] or ("#%s"):format(key)
end
