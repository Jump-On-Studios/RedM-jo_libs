...
---@param coords vec3 (The coordinates where the entity will be created)
---@param heading float (The heading direction for the entity)
---@param networked boolean (Whether the entity should be networked)
---@param fadeDuration integer (Duration of the fade-in effect in ms - default:0)
