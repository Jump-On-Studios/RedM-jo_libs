...
--- _data.id integer (The ID of the texture <br> ⚠️ Use either _data.id OR _data.albedo, not both)
--- _data.albedo string (The albedo of the texture <br> ⚠️ Use either _data.id OR _data.albedo, not both)
